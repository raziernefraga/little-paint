...
}   // fim do construtor MainWindow::MainWindow

MainWindow::~MainWindow() {
    // Nenhum recurso manual para liberar por enquanto
}
...
void MainWindow::createToolbars() {
    ...
    // Cria a barra de estilo e define nome interno
...
void MainWindow::setColorFromEyedropper(const QColor &color) {
    ...
    // Se quiser, atualize outlineColorButton ou fillColorButton aqui
}
...
void MainWindow::openPreferences() {
    ...
    thicknessBox->setValue(thickness);  // valor atual da ferramenta

    layout->addWidget(new QLabel("Default Thickness:"));
    layout->addWidget(thicknessBox);

    // Botão de cor já existente
    ...
    connect(okButton, &QPushButton::clicked, [&]() {
        thickness = thicknessBox->value();         // atualiza valor local
        canvas->setThickness(thickness);           // aplica no canvas
        updateTool();                              // atualiza ferramenta ativa
        dialog.accept();
    });
